 ...
 *
 * @author      Daniel Kerr
 * @copyright   Copyright (c) 2005 - 2017, App, Ltd. (https://www.App.com/)
...
class Action
{
     ...
     * @return mixed
     */
    public function execute(\App\System\Engine\Registry $registry, array &$args = [])
    {
        ...
        if ($object instanceof \App\System\Engine\Controller) {
